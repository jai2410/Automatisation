...
from vcs import BBB, Zoom 
class AutomatedPerson(DesktopBot):
    
    def __init__(self, name : str, number : int, max_number = 3, vcs = BBB):
        super().__init__()
        self.name = name
    ...
    def open_vcs(self):
        ...
        self.vcs.open_vcs()
        self.write_time_in_file("Start browser and open VCS URL")
        self.wait(3000)
    ...
    def __add_all_images(self):
        images = self.vcs.get_all_images()
